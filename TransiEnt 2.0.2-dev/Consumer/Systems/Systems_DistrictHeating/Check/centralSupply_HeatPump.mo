...
//________________________________________________________________________________//
  ...
  TransiEnt.Consumer.Systems.Systems_DistrictHeating.HeatPump_DistrictHeating heatPump_DistrictHeating(
    ...
    Q_flow_n=5000,
    P_el_n=20000,
    T_set=heatPump_DistrictHeating.heatingCurve.T_supply + 3,
    V_Storage=5,
    height=3,
    T_start=338.15,
...
equation
  ...
  connect(T_return.port, grid.waterPortOut_return) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(Q_flow_demand_heating_grid.y, heatPump_DistrictHeating.heatDemand) annotation (Line(points={{-51.85,-38},{-28,-38},{-28,-45.6}}, color={0,0,127}));
  connect(Supply_Temperature.y, supply_boundary.T) annotation (Line(points={{-69.85,52},{-56,52}}, color={0,0,127}));
  connect(ElectricGrid.epp, heatPump_DistrictHeating.epp) annotation (Line(
      points={{-62,-3},{-12,-3},{-12,-70},{-36,-70},{-36,-65.8}},
      color={0,127,0},
      thickness=0.5));
