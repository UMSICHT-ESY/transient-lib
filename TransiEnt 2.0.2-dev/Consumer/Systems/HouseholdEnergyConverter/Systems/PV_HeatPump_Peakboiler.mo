...
//________________________________________________________________________________//
  ...
  TransiEnt.Consumer.Heat.DHW_Booster dHW_Booster if hotwater_booster annotation (Placement(transformation(extent={{-10,48},{6,64}})));
...
equation
  ...
  elseif heating and not hotwater_booster then
    connect(demand.heatingPowerDemand, heatStorage1.Q_flow_demand) annotation (Line(points={{0,100.48},{0,80},{28,80},{28,66},{128,66},{128,46},{86,46}},               color={0,127,127}));
    connect(add1.y, apparentPower1.P_el_set) annotation (Line(points={{-42.7,43},{-66,43},{-66,-14},{-66.8,-14},{-66.8,-22.4}},          color={0,0,127}));
  elseif hotwater and not hotwater_booster then
    connect(demand.hotWaterPowerDemand, heatStorage1.Q_flow_demand) annotation (Line(points={{-4.8,100.48},{-4.8,80},{28,80},{28,62},{136,62},{136,42},{96,42},{96,46},{86,46}}, color={0,127,127}));
    connect(demand.electricPowerDemand, apparentPower1.P_el_set) annotation (Line(points={{4.68,100.48},{-34,100.48},{-34,100},{-74,100},{-74,64},{-76,64},{-76,16},{-92,16},{-92,-48},{-66.8,-48},{-66.8,-22.4}}, color={175,0,0}, pattern=LinePattern.Dash), Text(string="%first", index=-1,extent={{6,3},{6,3}},horizontalAlignment=TextAlignment.Left));
  ...
  connect(demand.electricPowerDemand, add1.u1) annotation (Line(points={{4.68,100.48},{4.68,94},{4,94},{4,88},{-18,88},{-18,47.2},{-26.6,47.2}},
                                                                                                                               color={0,127,127}));
  connect(demand.hotWaterPowerDemand, add1.u2) annotation (Line(points={{-4.8,100.48},{-4,100.48},{-4,80},{-16,80},{-16,38.8},{-26.6,38.8}},
                                                                                                                               color={0,127,127}));
