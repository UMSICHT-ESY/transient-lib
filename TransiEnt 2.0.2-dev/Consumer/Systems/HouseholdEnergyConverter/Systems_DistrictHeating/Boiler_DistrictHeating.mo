within TransiEnt.Consumer.Systems.HouseholdEnergyConverter.Systems_DistrictHeating;
...
//________________________________________________________________________________//
  ...
  extends TransiEnt.Consumer.Systems.HouseholdEnergyConverter.Systems_DistrictHeating.Base.Systems_DistrictHeating(
  ...
  parameter Modelica.Units.SI.Efficiency eta=1.05 "Boiler's overall efficiency" annotation (HideResult=true, Dialog(group="Boiler Parameters"));
  parameter Modelica.Units.SI.HeatFlowRate Q_flow_n_boiler=10000 "Nominal heating power of the gas boiler" annotation (HideResult=true, Dialog(group="Boiler Parameters"));
  ...
  replaceable model BoilerCostModel = TransiEnt.Components.Statistics.ConfigurationData.PowerProducerCostSpecs.GasBoiler
                                                                                                               annotation (__Dymola_choicesAllMatching=true, Dialog(group="Statistics"));
  ...
  TransiEnt.Producer.Heat.Gas2Heat.SimpleGasBoiler.SimpleBoiler gasBoiler(
    ...
    redeclare model BoilerCostModel = BoilerCostModel) annotation (Placement(transformation(extent={{-10,-10},{12,12}})));
...
equation
  ...
  connect(gasBoiler.gasIn, gasPortIn) annotation (Line(
      points={{1.22,-10},{1.22,-42},{80,-42},{80,-96}},
      color={255,255,0},
      thickness=1.5));
  connect(heatDemand, gasBoiler.Q_flow_set) annotation (Line(
      points={{0,104},{1,12}},
      color={175,0,0},
