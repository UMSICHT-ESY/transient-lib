within TransiEnt.Consumer.Systems.HouseholdEnergyConverter.Systems_DistrictHeating.Base;
...
public
  ...
  TransiEnt.Basics.Interfaces.Thermal.HeatFlowRateIn heatDemand annotation (Placement(transformation(
        extent={{12,12},{-12,-12}},
        rotation=90,
