...
equation
  ...
  connect(gas_Pipe.gasPortOut, gasPortOut) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(gas_Pipe.gasPortOut, Systems_1.gasPortIn) annotation (Line(
      points={{-86,60},{-12,60},{-12,126.48},{-11.2,126.48}},
      color={255,255,0},
      thickness=1.5));
  connect(Systems_2.gasPortIn, gas_Pipe.gasPortOut) annotation (Line(
      points={{-36.8,-130.44},{-36.8,60},{-86,60}},
      color={255,255,0},
      thickness=1.5));
  connect(gasPortOut, Systems_1.gasPortIn) annotation (Line(
      points={{120,60},{-12,60},{-12,126.48},{-11.2,126.48}},
      color={255,255,0},
      thickness=1.5));
  connect(gasPortOut, Systems_2.gasPortIn) annotation (Line(
  ...
  connect(Demand_1.demand, Systems_1.demand) annotation (Line(
      points={{-25.5,167.54},{-25.5,158.77},{-24,158.77},{-24,150}},
      color={102,44,145},
      pattern=LinePattern.Dash));
  connect(Demand_2.demand, Systems_2.demand) annotation (Line(
      points={{-23,-167.52},{-23,-158},{-24,-158},{-24,-152}},
      color={102,44,145},
      pattern=LinePattern.Dash));
  annotation (
