...
//________________________________________________________________________________//
 ...
 // _____________________________________________
   ...
   parameter Modelica.Units.SI.Energy E_max_battery=0 "Maximum capacity of the battery";
   parameter Modelica.Units.SI.Energy E_min_battery=0 "Maximum capacity of the battery";
   parameter Modelica.Units.SI.Power P_battery=2000 "Charging/discharging power of the battery";
   parameter Real eta_load_battery=0.95 "Conversion efficiency while loading";
   parameter Modelica.Units.SI.Frequency selfDischargeRate_battery=4e-9 "E.g. 0.5/3600 = 50% discharge per hour, used if no detailed staionary loss model is available";
