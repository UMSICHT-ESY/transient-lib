...
model PV_HeatPump_EV_Storage_complex "PV + Heatpump with thermal storage"
...
//________________________________________________________________________________//
  ...
  Masterarbeit.Thesis_Final.Thesis_POC_Modelle.POC_strombedingtesEngpassmanagement.SinglePhasePVInverter_complex inverter(
    eta=0.98,
    cosphi=1,
    behavior=1,
    P_n=12000,
  ...
  Masterarbeit.Thesis_Final.Thesis_Direktansteuerung.ElectricBoiler_complex electricHeater(
    change_sign=true,
    usePelset=true,
    Q_flow_n=4500*0.95,
    eta=0.95,
  ...
  Masterarbeit.Thesis_Final.Thesis_POC_Modelle.POC_strombedingtesEngpassmanagement.Heatpump_regression_Julian heatPump(
    use_T_storage=true,
    usePowerPort=true,
    Q_flow_n=10500,
    useFluidPorts=false,
    useHeatPort=false,
    HeatPumpType=TransiEnt.Producer.Heat.Power2Heat.Heatpump.Base.HeatpumpTypes.H2,
    T_set=328.15,
  ...
  Masterarbeit.Thesis_Final.Thesis_POC_Modelle.POC_strombedingtesEngpassmanagement.PVModule pVModule(
    P_inst=6000,
    Pmpp=Pmpp,
    Area=Area,
    Strings=Strings,
  ...
  Modelica.Blocks.Sources.RealExpression wind(y=simCenter.ambientConditions.wind.value) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-34,63})));
  Masterarbeit.Thesis_Final.Thesis_POC_Modelle.POC_strombedingtesEngpassmanagement.PVModule1 pVModule1(
    P_inst=6000,
    Pmpp=Pmpp,
    Area=Area,
    Strings=Strings,
  ...
  replaceable Masterarbeit.Thesis_Final.Thesis_POC_Modelle.POC_strombedingtesEngpassmanagement_EMS.ControlHeatpump_PVoriented_invHPEMS controller constrainedby Masterarbeit.Thesis_Final.Thesis_POC_Modelle.POC_spannungsbedingtesEngpassmanagement.ControlHeatpump_PVoriented(
    P_elHeater=P_el_n,
  ...
  replaceable Masterarbeit.Netz_Direktansteuerung.MaxSelfConsumption                                         controller1(zero1(y=0.9995)) if
                                                                                                                            battery constrainedby Masterarbeit.Netz_Direktansteuerung.MaxSelfConsumption                                         "Operation strategy of the battery" annotation (
    Dialog(group="Battery Parameters"),
    choicesAllMatching=true,
...
equation
  ...
  connect(electricHeater.epp, epp2) annotation (Line(
      points={{62,-70.2},{62,-82},{-58,-82},{-58,-98}},
      color={28,108,200},
      thickness=0.5));
  connect(controller.Q_flow_set_HP, heatPump.Set_value) annotation (Line(
      points={{-19.5,-8.41667},{4,-8.41667},{4,-22},{9.4,-22},{9.4,-17.4}},
      color={175,0,0},
      pattern=LinePattern.Dash));
...
end PV_HeatPump_EV_Storage_complex;
