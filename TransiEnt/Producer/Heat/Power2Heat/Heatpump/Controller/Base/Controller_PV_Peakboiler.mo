...
partial model Controller_PV_Peakboiler "Base class for controller models that orchestrate heatpump and peakboilder operation with exisiting pv systems"
...
//________________________________________________________________________________//
 ...
 // _____________________________________________
  ...
  parameter Boolean CalculatePeakBoiler=false "If true, peak boiler heat flow output is calculated for bivalent heat pump operation" annotation (Dialog(group="Configuration"),
  ...
  parameter SI.HeatFlowRate Q_flow_peakBoiler=5000 "Nominal generated heat flow of the peak boiler" annotation (Dialog(group="Heatpump", enable=CalculatePeakBoiler));
 ...
 TransiEnt.Basics.Interfaces.Thermal.HeatFlowRateOut Q_flow_set_peakBoiler if CalculatePeakBoiler annotation (Placement(transformation(extent={{96,-82},{122,-56}}), iconTransformation(extent={{92,-90},{118,-64}})));
